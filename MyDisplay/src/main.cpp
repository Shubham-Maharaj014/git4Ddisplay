...
public:
  LGFX(void)
  {
    { 
      ...
      cfg.pin_d0 = 17;  // pin number connecting D0
      cfg.pin_d1 = 16; // pin number connecting D1
      cfg.pin_d2 = 15;  // pin number connecting D2
      cfg.pin_d3 = 7;  // pin number connecting D3
      cfg.pin_d4 = 6; // pin number connecting D4
      cfg.pin_d5 = 21; // pin number connecting D5
      cfg.pin_d6 = 00; // pin number connecting D6
      cfg.pin_d7 = 46; // pin number connecting D7
    ...
    { // Set display panel control.
      ...
      cfg.memory_height = 800; // Maximum height supported by driver IC
...
//*
    { // Configure settings for touch screen control. (delete if not necessary)
      ...
      cfg.x_max = 479; // Maximum X value (raw value) obtained from the touchscreen
      cfg.y_min = 0;   // Minimum Y value obtained from touchscreen (raw value)
      cfg.y_max = 799; // Maximum Y value (raw value) obtained from the touchscreen
      cfg.pin_int = 40; // pin number to which INT is connected
      ...
      cfg.pin_sda = 48;     // pin number where SDA is connected
      cfg.pin_scl = 47;     // pin number to which SCL is connected
